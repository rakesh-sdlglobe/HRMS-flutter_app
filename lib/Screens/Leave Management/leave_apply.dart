...
class _LeaveApplyState extends State<LeaveApply> {
  ...
  void applyLeave() {
    if (installment == 'Casual Leave') {
      ...
      String leaveDuration = isFullDay ? 'Full Day' : 'Half Day';
      String leaveDate = oneDateController.text;
      String description = descriptionController.text;

      if (!isFullDay) {
        leaveDate =
            "$leaveDate ${selectedStartTime != null ? selectedStartTime!.format(context) : '00:00'} - ${selectedEndTime != null ? selectedEndTime!.format(context) : '00:00'}";
      }
